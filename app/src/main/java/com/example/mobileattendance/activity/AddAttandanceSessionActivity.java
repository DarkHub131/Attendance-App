...
import com.example.mobileattendance.bean.AttendanceBean;
import com.example.mobileattendance.bean.AttendanceSessionBean;
import com.example.mobileattendance.bean.FacultyBean;
import com.example.mobileattendance.bean.StudentBean;
import com.example.mobileattendance.context.ApplicationContext;
...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
    ...
    private String[] subjectAEString = new String[] {"M1","M2","C++","EEE"};

	private String[] subjectFinal = new String[] {"DIGITAL","EEE","M1","DS","M2","IOT","C/C++","ANDROID","JAVA","CHE","MEC","HTML","ECE","CHE"};
